...
new_saver = tf.train.import_meta_graph('data/mnist_mode/00000001/export.meta')
new_saver.restore(sess, 'data/mnist_mode/00000001/export')

# print to see the restored variables
for v in tf.get_collection('variable'):
    print(v.name)
