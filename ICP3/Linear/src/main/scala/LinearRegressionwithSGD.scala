...
//    System.setProperty("hadoop.home.dir","C:\\Users\\Manikanta\\Documents\\UMKC Subjects\\PB\\hadoopforspark");
    ...
    val parsedData = data.map { line =>
      ...
      LabeledPoint(parts(0).toDouble, Vectors.dense(Array(parts(1).toDouble,parts(2).toDouble,parts(3).toDouble)))}.cache()

    parsedData.take(4).foreach(f=>println(f))
    ...
    // Save and load model
    model.save(sc, "C:\\Users\\sidra\\Downloads\\CS5542-Tutorial3-SourceCode\\Linear\\data\\LinearRegressionWithSGDModel")
    val sameModel = LinearRegressionModel.load(sc, "C:\\Users\\sidra\\Downloads\\CS5542-Tutorial3-SourceCode\\Linear\\data\\LinearRegressionWithSGDModel")
  }
