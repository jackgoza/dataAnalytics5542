...
MNIST = input_data.read_data_sets("MNIST_data/", one_hot=True, validation_size=40)
learning_rate = 0.01
batch_size = 10
n_epochs = 20
...
plt.subplot(2, 1, 1)
plt.plot(loss_history, '-*', label='Cost value')
plt.title('Training Cost')
plt.xlabel('Epoch')
plt.ylabel('Cost Value')
plt.legend(ncol=2, loc='upper right')
plt.subplot(2, 1, 2)
plt.plot(acc_history, '-*', label='Accuracy value')
